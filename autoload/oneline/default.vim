...
class DefaultConfig
    ...
    def new()
        ...
        this.preset.components = {
            mode: {
                content: this.Mode_Content,
                hlgroup: ''
            },
            paste: {
                content: () => &paste ? 'PASTE' : '',
        ...
        this.preset.theme = 'default'
        this.preset.separator = { left: '', right: '', margin: ' '} 
        this.preset.subseparator = { left: '', right: '', margin: ' '}
        this.preset.mode_map = {
            n: 'NORMAL',   
            niI: 'I-NORMAL',
            niR: 'R-NORMAL',
            niV: 'R-NORMAL',
    ...
    def Mode_Content(): string
        const mode_map: dict<string> = this.preset.mode_map
...
export final Default = DefaultConfig.new()
